...
const Footer = () => {
    return <footer className={'text-white mp-20'}>
        <div className={'overflow-x-hidden -mb-0.5'}>
            <svg
                ...
                "172-41.86 82.39-16.72 168.19-17.73 250.45-.39C823.78" +
                " 31 906.67 72 985.66 92.83c70.05 18.48 146.53 23.09 214.34" +
                            ...
                            <div className={"mb-10 flex flex-col gap-3 "}>
                                {
                                    links.map((link, indexedDB)=> (
                                        <Link to={'/'} className={"text-gray-300 text-sm hover:text-white"} key={link}>
                                            {link}
                                        </Link>
                                    ))
                                }
        ...
        <div className={"bg-[#001a36]"}>
            <div className={"container mx-auto py-4 px-5 flex flex-wrap flex-col "}>
                <p className={"text-gray-300 text-sm text-center"}>
                    &copy; 2024 Maxim Boukun JobFinder
                </p>
            </div>
