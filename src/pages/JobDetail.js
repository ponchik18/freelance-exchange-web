...
import {CustomButton, Error404, FreelancerCard, JobCard, ProposalForm, SkillList} from "../components";
            ...
            <div className='w-full flex flex-col md:flex-row gap-10'>
                <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
                  ...
                  {moment(job?.createdAt).fromNow()}
                    ...
                    { (!user && !!job?.proposals?.find((proposal)=>proposal.freelancer.userId === user?.userId) && job?.jobStatus === 'CREATED') && (
