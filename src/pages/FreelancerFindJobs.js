...
import {getAllJobs, getAllJobsForFreelancerSmartSearch} from "../axios/JobService";
import {useKeycloak} from "@react-keycloak/web";
import {getAllSkills, getAllSkillsForFreelancerForSmartSearch} from "../axios/SkillService";
import {RotatingLines} from "react-loader-spinner";
import {useSelector} from "react-redux";

const FreelancerFindJobs = () => {
    ...
    const fetchJobs = async () => {
        ...
        try {
            const response = await getAllJobsForFreelancerSmartSearch(user.userId, params);
    ...
    useEffect(() => {
        const fetchData = async () => {
            await fetchJobs();
            const response = await getAllSkillsForFreelancerForSmartSearch(user.userId, token)
    ...
    }, [skillIds, search, startBudget, endBudget, sort, user]);
